...
for i=1:length(gmhpolicies)
    ...
    GMHRunnersTest.setfrom(indicatorstate1,gv1,gll1) ; GMHRunnersTest.setproposals(indicatorstate1,gv2,gll2)
    GMHRunnersTest.setsegment(remotesegments1,gv2,gll2,gv3,gll3,1) ; GMHRunnersTest.setindicator(indicator1,[1.0,0.0,0.0],[3,1,1])
    indicatorstate1 = preparenext!(gmhrunners[i],rmodel1,indicatorstate1,remotesegments1,indicator1)
    GMHRunnersTest.testfrom(indicatorstate1,gv3,gll3)
    GMHRunnersTest.setfrom(indicatorstate1,gv1,gll1) ; GMHRunnersTest.setproposals(indicatorstate1,gv2,gll2)
    GMHRunnersTest.setsegment(remotesegments1,gv2,gll2,gv3,gll3,1) ; GMHRunnersTest.setindicator(indicator1,[0.0,0.0,1.0],[3,3,3])
    indicatorstate1 = preparenext!(gmhrunners[i],rmodel1,indicatorstate1,remotesegments1,indicator1)
    GMHRunnersTest.testfrom(indicatorstate1,gv1,gll1)

    println("Testing of store! function")
    #test storing a value into the chain
    GMHRunnersTest.setfrom(indicatorstate1,gv1,gll1) ; GMHRunnersTest.setproposals(indicatorstate1,gv2,gll2)
    GMHRunnersTest.setsegment(remotesegments1,gv2,gll2,gv3,gll3,2) ; GMHRunnersTest.setindicator(indicator1,[1.0,0.0,0.0],[3,1,2])
    store!(gmhrunners[i],indicatorstate1,remotesegments1,indicator1,chain1)
    GMHRunnersTest.teststore(chain1,gv3,gll3[1],2,2,2)
    GMHRunnersTest.setfrom(indicatorstate1,gv1,gll1) ; GMHRunnersTest.setproposals(indicatorstate1,gv2,gll2)
    GMHRunnersTest.setsegment(remotesegments1,gv2,gll2,gv3,gll3,2) ; GMHRunnersTest.setindicator(indicator1,[0.0,0.0,1.0],[3,3,3])
    store!(gmhrunners[i],indicatorstate1,remotesegments1,indicator1,chain1)
    GMHRunnersTest.teststore(chain1,gv1,gll1[1],4,2,4)
    ...
    GMHRunnersTest.testfrom(indicatorstate2,indicatorstate1.from.values,indicatorstate1.from.loglikelihood)
    GMHRunnersTest.testproposals(indicatorstate2,indicatorstate1.proposals.values,indicatorstate1.proposals.loglikelihood)
